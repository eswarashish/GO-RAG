...
type AddRequest struct {
	...
	B             int32                  `protobuf:"varint,2,opt,name=b,proto3" json:"b,omitempty"` //these are just ids and not actual values to be precise
...
const file_proto_calc_proto_rawDesc = "" +
	...
	"\n" +
	"Calculator\x12*\n" +
	"\x03Add\x12\x10.calc.AddRequest\x1a\x11.calc.AddResponseB\x0eZ\fGO-RAG/protob\x06proto3"
